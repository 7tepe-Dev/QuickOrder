...
public class WriteDefaults 
{
	...
	public static void WriteDefaultUsers()
	{
		...
		Customer c1=new Customer("fatihYenilmez","1987fatih,",UserType.CUSTOMER,200,"İstanbul");
		Customer c2=new Customer("Jonathan43","_JJJ43",UserType.CUSTOMER,1500,"London");
		Customer c3=new Customer("HakkıTastepe","hakkı1234",UserType.CUSTOMER,50,"Ankara");
		Customer c4=new Customer("Meryem_bilen","19/03/2019",UserType.CUSTOMER,400,"İstanbul");
		...
		Restaurant dessert=new Restaurant("Tatlı Yiyelim");
		...
		baranEv.addNewProduct(new Product("Fırın Köfte",writedef.getPath()+baranEv.getRestaurantName()+"/Fırın Köfte.jpg",32.80));
		baranEv.addNewProduct(new Product("Lahana Sarması",writedef.getPath()+baranEv.getRestaurantName()+"/Lahana Sarması.jpg",23));
		baranEv.addNewProduct(new Product("Mantar Sote",writedef.getPath()+baranEv.getRestaurantName()+"/Mantar Sote.jpg",28.50));
		baranEv.addNewProduct(new Product("Karısık Menemen",writedef.getPath()+baranEv.getRestaurantName()+"/Karısık Menemen.jpg",23.75));
		baranEv.addNewProduct(new Product("Fanta (33 cl.)",writedef.getPath()+baranEv.getRestaurantName()+"/Fanta.jpg",5));
		baranEv.setRestaurantLocation("İstanbul");
		...
		User.addNewUserToList(new Owner("Tatlıcı Sefa","_-sefaSS23,",UserType.OWNER,dessert,86320));
